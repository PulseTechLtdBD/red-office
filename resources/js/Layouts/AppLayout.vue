...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100 dark:bg-gray-900">
            <nav class="relative z-50 bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 overflow-visible">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-5 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink :href="route('user-profiles.index')" :active="route().current('user-profiles.index')">
                                    User Profiles
                                </NavLink>
